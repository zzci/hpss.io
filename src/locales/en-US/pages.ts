export default {
  ...
  'pages.sso.login': 'SSO Login',
  'pages.sso.title': 'HPS Operations Portal',
  'pages.sso.subtitle': 'Welcome to HPS Operations Management System',
  'pages.sso.submit': 'HPS SSO Login',
  'pages.login.sso.error': 'SSO Configuration Error',
